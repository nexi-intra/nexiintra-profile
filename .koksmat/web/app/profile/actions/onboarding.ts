...
export async function createInvitation(data: any): Promise<Result<CreateInvitationResult>> {
    ...
    if (!graphData.hasError) {
        ...
        console.log("Profile", "createInvitation", { status: "Cannot get user from graph", data, graphData, user })
    ...
    if (!user) {
        ...
        if (invitationResult.hasError) {
            console.log("Profile", "createInvitation", { status: "Cannot create guest invitation", data, graphData, invitationResult, user })
    ...
    console.log("Profile", "createInvitation", { status: "OK", data, graphData, invitationResult, user })
