...
export function ValidateEmailAccountForm() {
  ...
  async function onSubmit(data: ProfileFormValues) {
    ...
    // })
    setInvitationStatus(undefined);
    const x = await createInvitation(data, false);
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormDescription className="max-w-screen-sm">
                  Your email is validated against our user database. If we
                  cannot find yours, and if your are working for a company which
                  have not yet been onboarded we will create an invitation for
                  your account.
                </FormDescription>
